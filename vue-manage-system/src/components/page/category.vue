    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i> 分类信息
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            <div class="handle-box">
                ...
                >批量删除</el-button>
                <el-input v-model="query.data.name" placeholder="分类名" class="handle-input mr10"></el-input>
...
export default {
    ...
    methods: {
        ...
        getData() {
          ...
          Axios.post("/api/category/findpage",this.query).then((response)=>{
